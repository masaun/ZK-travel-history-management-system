...
/**
 * @notice - Deployment script to deploy all SCs at once - on Celo Testnet
...
contract DeploymentAllContracts is Script {
    ...
    function run() public {
        vm.createSelectFork("celo_testnet");
        ...
        /// @dev - Logs of the deployed-contracts on Celo Sepolia Testnet
        console.logString("Logs of the deployed-contracts on Celo Sepolia Testnet");
        console.logString("\n");
